...
export default function AnswerButton({
  ...
  let btnClass =
    "btn btn-primary rounded-full shadow-sm transition-all duration-300 w-full py-2 sm:py-3 md:py-4 px-6 sm:px-8 md:px-10 lg:px-12 xl:px-14 flex items-center justify-center gap-3 text-base md:text-lg lg:text-xl h-auto min-h-[48px] sm:min-h-[56px] md:min-h-[64px] max-h-[110px] sm:max-h-[90px] md:max-h-[80px] overflow-hidden";

  if (isPickedWrong) {
    // Incorrect answer: force error border + half opacity and make it disabled
    btnClass =
      "btn btn-outline btn-content rounded-full shadow-sm transition-all duration-300 w-full py-2 sm:py-3 md:py-4 px-6 sm:px-8 md:px-10 lg:px-12 xl:px-14 flex items-center justify-center gap-3 text-base md:text-lg lg:text-xl h-auto min-h-[48px] sm:min-h-[56px] md:min-h-[64px] max-h-[110px] sm:max-h-[90px] md:max-h-[80px] overflow-hidden !border-2 !border-error opacity-50 btn-disabled";
  } else if (disabled) {
