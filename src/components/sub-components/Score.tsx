  ...
  if (gameStarted) {
    return (
      <>
        ...
        <div className="font-semibold flex flex-col items-center gap-2 relative place-content-center place-items-center transform -translate-y-8 sm:-translate-y-10 md:-translate-y-14 lg:-translate-y-24 z-[2300]">
