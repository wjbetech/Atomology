...
export default function AtomsIcon({ className = "" }) {
  return (
    <svg
      className={className}
      ...
      role="img"
      aria-label="Atomology logo"
    >
      {/* outer teardrop */}
      <path
        className="atoms-fill-1"
        d="M245.764,491.52c-60.674,0-108.203-107.949-108.203-245.76S185.09,0,245.764,0
    ...
    s41.651,228.514,90.956,228.514c49.296,0,90.947-104.649,90.947-228.514S295.061,17.246,245.764,17.246z"
      ...
      {/* large mid shape (was white) */}
      <path
        className="atoms-fill-2"
        d="M109.309,400.951c-36.353,0-63.823-10.552-76.387-32.311C2.59,316.092,72.316,220.96,191.659,152.05
    ...
    C309.772,115.46,254.169,135.874,200.282,166.99L200.282,166.99z"
      ...
      {/* green shape */}
      <path
        className="atoms-fill-3"
        d="M382.707,401.01c-8.766,0-18.114-0.623-28.017-1.878c-49.306-6.248-107.209-27.435-163.032-59.672
