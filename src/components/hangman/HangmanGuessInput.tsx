    ...
    <div className="w-full flex justify-center px-6 sm:px-0">
      ...
      >
        <input
          ...
          className="flex-1 w-full text-center text-lg leading-10 rounded-full bg-neutral-100 dark:bg-primary-content  text-white border border-gray-500 focus:border-blue-400 px-4 placeholder:text-sm placeholder:italic placeholder:text-gray-400"
          value={wordGuess}
